 ...
 *                   type: string
 */
transferRoutes.patch('/:id', authenticateToken, transferController.updateTransferStatus);
 ...
 *
 */
transferRoutes.get('/', authenticateToken, transferController.getTransferList);
